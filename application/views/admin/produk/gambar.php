...
<div class="col-md-7">
    <input type="text" name="judul_gambar" class="form-control" placeholder="Judul Gambar Buku" value="<?php echo set_value('judul_gambar') ?>" required>
  </div>
</div>
...
<div class="col-md-3">
    <input type="file" name="gambar" class="form-control" placeholder="Gambar Buku" value="<?php echo set_value('gambar') ?>" required>
  </div>
  <div class="col-md-5">
...
<table class="table table-bordered" id="example1">
	...
	<tbody>
		<tr>
			<td>1</td>
			<td>
				<img src="<?php echo base_url('assets/upload/image/thumbs/'.$produk->gambar) ?>" class="img-responsive img-thumbnail" width="60">
			</td>
		...
		<tr>
			<td><?php echo $no ?></td>
			<td>
				<img src="<?php echo base_url('assets/upload/image/thumbs/'.$gambar->gambar) ?>" class="img-responsive img-thumbnail" width="60">
			</td>
