...
class Produk_model extends CI_Model {
	...
	public function newest($limit,$start)
	{
		$this->db->select('produk.*,
	 					users.nama,
	 					kategori.nama_kategori,
	...
	public function lowest($limit,$start)
	{
		$this->db->select('produk.*,
	 					users.nama,
	 					kategori.nama_kategori,
	...
	public function highest($limit,$start)
	{
		$this->db->select('produk.*,
	 					users.nama,
	 					kategori.nama_kategori,
	...
	public function harga100000($limit,$start)
	{
		$this->db->select('produk.*,
	 					users.nama,
	 					kategori.nama_kategori,
	 	...
	 	$this->db->like('produk.harga');
	 	$this->db->limit($limit,$start);
	 	$query = $this->db->get();
	 	return $query->result();
	}

	public function harga250000($limit,$start)
	{
		$this->db->select('produk.*,
	 					users.nama,
	 					kategori.nama_kategori,
	...
	public function harga500000($limit,$start)
	{
		$this->db->select('produk.*,
	 					users.nama,
	 					kategori.nama_kategori,
	...
	public function harga1000000($limit,$start)
	{
		$this->db->select('produk.*,
	 					users.nama,
	 					kategori.nama_kategori,
